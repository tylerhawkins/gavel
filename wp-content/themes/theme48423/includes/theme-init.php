...
if ( ! function_exists( 'my_setup' ) ):
	function my_setup() {
		...
		if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
			...
			add_image_size( 'slider-post-thumbnail', 1600, 602, true ); // Slider Thumbnail
...
/* Services */
function my_post_type_solutions() {
...
add_action('init', 'my_post_type_solutions');
...
function my_post_type_houses() {
	register_post_type( 'houses',
		array( 
				'label'               => __('Houses', CURRENT_THEME),
				'singular_label'      => __('Houses', CURRENT_THEME),
				'_builtin'            => false,
				// 'exclude_from_search' => true, // Exclude from Search Results
				'capability_type'     => 'page',
				'public'              => true, 
	...
	register_taxonomy('houses_category', 'houses', array('hierarchical' => true, 'label' => theme_locals("categories"), 'singular_name' => theme_locals("category"), 'rewrite' => true, 'query_var' => true));
}
