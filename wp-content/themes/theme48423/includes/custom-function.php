<?php
	...
	require_once('shortcodes/posts_grid.php');
	require_once('extra-selectors.php');

	add_filter( 'cherry_back_top_html', 'child_to_top' );
	function child_to_top() {
	    return "<a href='#top'><i class='icon-upload'></i></a>";
	}

	add_filter( 'cherry_slider_params', 'child_slider_params' );
	function child_slider_params( $params ) {
	    $params['minHeight'] = '"50px"';
	    $params['height'] = '"37.645%"';
	return $params;
	}
