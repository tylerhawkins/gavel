...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '17px', 'lineheight' => '26px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '62px', 'lineheight' => '75px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '50px', 'lineheight' => '60px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '48px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '36px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '31px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '26px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '60px', 'lineheight' => '72px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '17px', 'lineheight' => '20px', 'face' => 'Cabin', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => 'Cabin', 'style' => 'normal', 'character'  => 'latin', 'color' => '#6c706c'));
		return $options;
	}
}
?>
